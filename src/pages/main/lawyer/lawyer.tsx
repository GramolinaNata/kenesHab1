...
//   Hash,
// } from "lucide-react";
// // import { useProposals } from "@/features/application/hooks/useApplication"; // временно отключено
// import {
//   Card,
//   CardContent,
//   CardHeader,
...
// // ========================
// // MOCK DATA — удалить после разработки
// // ========================
...
//       contract: null,
//       creditor_response: {
//         file: "https://example.com/response.pdf",
//       },
//     },
//     borrower: {
//       id: 11,
...
//   // TODO: заменить мок на реальный хук после разработки:
//   // const { data: proposalsData, isLoading } = useProposals();
//   // const proposals = proposalsData?.results || [];
...
//                             </span>
//                             <Badge variant="outline" className="text-xs">
//                               {proposal.vacancy?.status_display_ru || "Не указан"}
//                             </Badge>
//                           </div>
//                           <div className="flex justify-between items-center">
//                             <span className="text-sm text-gray-600">
...
//                             <span className="text-sm font-medium text-gray-900">
//                               {proposal.vacancy?.fee
//                                 ? parseFloat(proposal.vacancy.fee).toLocaleString()
//                                 : "0"}{" "}
//                               ₸
//                             </span>
//                           </div>
...
//                                     <p className="text-xs text-gray-500">
//                                       Загружен{" "}
//                                       {formatShortDate(proposal.application.document.created_at)}
//                                       {proposal.application.document.signed && " • Подписан"}
//                                     </p>
//                                   </div>
//                                 </div>
//                                 <Eye className="h-4 w-4 text-gray-400 group-hover:text-blue-600 flex-shrink-0 ml-2" />
...
//                                     </p>
//                                     <p className="text-xs text-gray-500">
//                                       от {formatShortDate(proposal.application.contract.date)}
//                                     </p>
//                                   </div>
//                                 </div>
//                                 <Eye className="h-4 w-4 text-gray-400 group-hover:text-green-600 flex-shrink-0 ml-2" />
...
//                                       Ответ кредитора
//                                     </p>
//                                     <p className="text-xs text-purple-600">Файл ответа</p>
//                                   </div>
//                                 </div>
//                                 <Eye className="h-4 w-4 text-gray-400 group-hover:text-purple-600 flex-shrink-0 ml-2" />
//                               </button>
...
//                         <div className="space-y-3">
//                           <button
//                             onClick={() => handleViewBorrower(proposal.borrower)}
//                             className="w-full text-left hover:bg-white p-2 rounded-lg transition-colors group"
//                           >
//                             <div className="flex items-center gap-3">
//                               <Avatar className="h-10 w-10 border-2 border-green-100">
...
//                               <div className="flex items-center gap-2 text-gray-600">
//                                 <Phone className="h-3.5 w-3.5 flex-shrink-0" />
//                                 <span className="text-xs truncate">{proposal.borrower.phone}</span>
//                               </div>
//                             )}
//                             {proposal.borrower?.iin && (
//                               <div className="flex items-center gap-2 text-gray-600">
//                                 <Hash className="h-3.5 w-3.5 flex-shrink-0" />
//                                 <span className="text-xs">{proposal.borrower.iin}</span>
//                               </div>
//                             )}
//                             {proposal.borrower?.address && (
//                               <div className="flex items-center gap-2 text-gray-600">
//                                 <MapPin className="h-3.5 w-3.5 flex-shrink-0" />
//                                 <span className="text-xs truncate">{proposal.borrower.address}</span>
//                               </div>
//                             )}
//                           </div>
...
//                             className="w-full mt-2"
//                             onClick={() =>
//                               proposal.borrower && handleViewBorrower(proposal.borrower)
//                             }
//                           >
//                             <User className="h-4 w-4 mr-2" />
//                             Подробнее
...
//                 <div className="flex items-start gap-3">
//                   {selectedDocument.type === "document" && (
//                     <FileSignature size={24} className="text-blue-600 flex-shrink-0 mt-1" />
//                   )}
//                   {selectedDocument.type === "contract" && (
//                     <FileText size={24} className="text-green-600 flex-shrink-0 mt-1" />
//                   )}
//                   {selectedDocument.type === "response" && (
//                     <FileText size={24} className="text-purple-600 flex-shrink-0 mt-1" />
//                   )}

//                   <div className="flex-1 min-w-0">
//                     <h3 className="font-medium text-base mb-4">{selectedDocument.title}</h3>
...
//                     {selectedBorrower.full_name}
//                   </h3>
//                   <p className="text-sm text-gray-500">ID: {selectedBorrower.id}</p>
//                 </div>
//               </div>
...
//                     <div>
//                       <p className="text-xs text-gray-500">Email</p>
//                       <p className="text-sm font-medium text-gray-900">{selectedBorrower.email}</p>
//                     </div>
//                   </div>
//                 )}
...
//                     <div>
//                       <p className="text-xs text-gray-500">Телефон</p>
//                       <p className="text-sm font-medium text-gray-900">{selectedBorrower.phone}</p>
//                     </div>
//                   </div>
//                 )}
...
//                     <div>
//                       <p className="text-xs text-gray-500">ИИН</p>
//                       <p className="text-sm font-medium text-gray-900">{selectedBorrower.iin}</p>
//                     </div>
//                   </div>
//                 )}
...
//                     <div>
//                       <p className="text-xs text-gray-500">Адрес</p>
//                       <p className="text-sm font-medium text-gray-900">{selectedBorrower.address}</p>
//                     </div>
//                   </div>
//                 )}
