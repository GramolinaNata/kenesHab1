...
const ProcessSection = () => {
  const steps = [
    ...
    },
    {
      ...
      description:
        "Просмотрите сгенерированный документ, внесите правки.",
      icon: ShieldCheck,
    },
    {
      number: "04",
...
const FAQSection = () => {
  ...
  const faqs = [
    { question: "Как работает сервис KenesHab?", answer: "KenesHab — это цифровая платформа, которая использует искусственный интеллект для автоматического составления юридически грамотных заявлений для досудебного урегулирования задолженности. Вы заполняете анкету, ИИ формирует документ." },
    ...
    { question: "Какие документы нужны для начала работы?", answer: "Вам потребуется паспорт РК, данные о кредитном договоре (номер, дата, сумма), информация о кредиторе (банк, МФО)" },
